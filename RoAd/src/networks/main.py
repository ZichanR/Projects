from .VisAnaML_LSTM import VisAnaML_LSTM, VisAnaML_LSTM_Autoencoder, Prediction_MLP
...
def build_network(net_name, ae_net=None):
    ...
    implemented_networks = ('VisAnaML_LSTM', 'mnist_DGM_M2', 'mnist_DGM_M1M2',
    ...
    if net_name == 'VisAnaML_LSTM':
        net = VisAnaML_LSTM(96,21)
        net.pred_adv = Prediction_MLP(net.rep_dim)
...
def build_autoencoder(net_name):
    ...
    implemented_networks = ('VisAnaML_LSTM', 'mnist_DGM_M1M2',
    ...
    if net_name == 'VisAnaML_LSTM':
        ae_net = VisAnaML_LSTM_Autoencoder(96,21)
