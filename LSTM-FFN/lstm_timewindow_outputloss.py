...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 02:03:19 2020
...
def run_LSTM_fit_all_timewindow(window, n_output = 1, n_epoch=100, classweight = True, n2v = [False, 0], activationfunc='sigmoid', checkpmonitor='loss'):
    ...
    bst_weight_filepath = 'model_outputloss/trainall_weights_window_{}_output{}_{}_{}_{}_n2v{}_{}.h5'.format(window, n_output, classweight, n_epoch, activationfunc, n2v[1], checkpmonitor)
    ...
    if classweight:
        ...
        # fit model
        print("\nTraining Modle. With {:d} day(s) time window, {:d} epochs and {} class weight during training, {:d} dimensions of node to vector input, {:s} as activation, {:d} final output dimensions, {:s} as checkpoint monitor.".format(window, n_epoch, classweight, n2v[1], activationfunc, n_output, checkpmonitor))
        ...
        historypath = 'HistoryDict/historydic_w_{}_output{}_{}_{}_{}_n2v{}_{}.txt'.format(window, n_output, classweight, n_epoch, activationfunc, n2v[1], checkpmonitor)
    ...
    performance_list = []
    performance_filepath = 'performance_time_window_outputloss/trainall_performance_w_{}_output{}_{}_{}_{}_n2v{}_{}.txt'.format(window,n_output, classweight, n_epoch, activationfunc, n2v[1], checkpmonitor)
    model = load_model('model_outputloss/trainall_weights_window_{}_output{}_{}_{}_{}_n2v{}_{}.h5'.format(window, n_output, classweight, n_epoch, activationfunc, n2v[1], checkpmonitor),
    ...
    console_show = 'Prediction result: with {:d} day(s) time window, {:d} epochs and {} class weight during training, {:d} dimensions of node to vector input, {:s} as activation, {:d} final output dimensions, {:s} as checkpoint monitor.'.format(window, n_epoch, classweight, n2v[1], activationfunc, n_output, checkpmonitor)
    print(console_show)
    if n_output == 1:
...
run_LSTM_fit_all_timewindow(window=1, n2v=[True, 8])
run_LSTM_fit_all_timewindow(window=1, n2v=[True, 128])